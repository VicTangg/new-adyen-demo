...
def test_store_update_rejects_without_admin_token():
    client = make_client()
...
def test_split_rule_update_rejects_wrong_admin_token():
...
def test_split_logic_update_allows_matching_admin_token():
    client = make_client(admin_token="correct-token")
    ...
    assert response.get_json() == {"id": "updated"}
