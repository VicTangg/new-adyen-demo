...
ADYEN_MANAGEMENT_ADMIN_TOKEN=your_random_admin_token
```
...
- **ADYEN_MANAGEMENT_ADMIN_TOKEN**: Required for server-side Adyen Management PATCH endpoints. Leave unset to disable Management updates.
