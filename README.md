...
- **ADYEN_MANAGEMENT_WRITE_TOKEN**: required for API routes that mutate Adyen Management resources. The checkout admin UI prompts for this token before PATCH requests.
