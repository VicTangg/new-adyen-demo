...
ADYEN_MANAGEMENT_WRITE_TOKEN=generate-a-random-admin-token
```
...
- **ADYEN_MANAGEMENT_WRITE_TOKEN**: Required for PATCH routes that modify Adyen Management resources. Send it as `Authorization: Bearer <token>` or `X-Adyen-Management-Write-Token`.
