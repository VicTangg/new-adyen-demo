...
- **ADYEN_MANAGEMENT_WRITE_TOKEN**: Required to enable store and split configuration update routes. Send it with `Authorization: Bearer <token>` or `X-Adyen-Management-Write-Token`.
