...
ADYEN_MANAGEMENT_WRITE_TOKEN=generate_a_long_random_admin_write_token
...
- **ADYEN_MANAGEMENT_WRITE_TOKEN**: required to enable Management API write endpoints. Send it as a bearer token or `X-Adyen-Management-Write-Token` header when updating stores or split configuration rules.
